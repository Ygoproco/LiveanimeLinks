...
function c511001723.filter(c,ft,tp)
	local re=c:GetReasonEffect()
	return (ft>0 or c:GetSequence()<5) and c:GetLevel()==7 and c:IsSetCard(0xe6)
...
function c511001723.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c511001723.filter,1,false,nil,nil,ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c511001723.filter,1,1,false,nil,nil,ft,tp)
