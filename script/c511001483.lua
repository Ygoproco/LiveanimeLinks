...
function c511001483.filter(c,g)
...
function c511001483.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:SetLabelObject(g)
	g:KeepAlive()
	return Duel.IsExistingMatchingCard(c511001483.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,g)
end
...
function c511001483.repop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		local xyz=Duel.SelectMatchingCard(tp,c511001483.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil,g)
