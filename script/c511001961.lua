...
function c511001961.cfilter(c,ft)
	return c:IsAbleToHandAsCost() and (ft>0 or c:GetSequence()<5)
end
function c511001961.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	if chk==0 then ft>-1 and Duel.IsExistingMatchingCard(c511001961.cfilter,tp,LOCATION_MZONE,0,1,nil,ft) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectMatchingCard(tp,c511001961.cfilter,tp,LOCATION_MZONE,0,1,1,nil,ft)
