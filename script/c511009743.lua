...
function c511009743.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(511009743,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCode(EVENT_DESTROYED)
	e2:SetCountLimit(1,511019743)
	e2:SetCondition(c511009743.reccon2)
	e2:SetTarget(c511009743.rectg2)
	e2:SetOperation(c511009743.recop2)
	c:RegisterEffect(e2)
	aux.CallToken(420)
end
...
function c511009743.recop2(e,tp,eg,ep,ev,re,r,rp)
