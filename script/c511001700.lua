...
function c511001700.filter(c,ft,tp)
...
function c511001700.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c511001700.filter,1,false,nil,nil,ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c511001700.filter,1,1,false,nil,nil,ft,tp)
