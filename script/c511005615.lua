...
function c511005615.initial_effect(c)
--special summon
...
e2:SetOperation(c511005615.op2)
c:RegisterEffect(e2)
--required
...
function c511005615.op2(e,tp,eg,ep,ev,re,r,rp)
local ct=e:GetLabel()
ct=ct+1
e:SetLabel(ct)
