...
function c511005760.initial_effect(c)
--atkdown
local e3=Effect.CreateEffect(c)
e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS+EFFECT_TYPE_TRIGGER_F)
e3:SetCode(EVENT_PREDRAW)
e3:SetRange(LOCATION_MZONE)
e3:SetCondition(c511005760.atkcon)
e3:SetOperation(c511005760.atkop)
e3:SetCountLimit(1)
c:RegisterEffect(e3)
end

function c511005760.atkcon(e,tp,eg,ep,ev,re,r,rp)
return Duel.GetTurnPlayer()==tp and e:GetHandler():IsDefensePos()
end

function c511005760.atkop(e,tp,eg,ep,ev,re,r,rp)
