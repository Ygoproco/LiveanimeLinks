...
function c511005851.op(e,tp,eg,ep,ev,re,r,rp)
--reduce cards in emzone
local g=Duel.GetMatchingGroup(c511005851.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil,e:GetHandler():GetPreviousSequence(),tp,e:GetHandler():GetPreviousLocation())
local tc=g:GetFirst()
while tc do 
