...
function c511000003.initial_effect(c)
	...
	e1:SetCondition(c511000003.condition)
	e1:SetCost(aux.RemainFieldCost)
	e1:SetTarget(c511000003.target)
	e1:SetOperation(c511000003.operation)
	c:RegisterEffect(e1)
end
function c511000003.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511000003.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,e:GetHandler(),1,tp,LOCATION_MZONE)
end
function c511000003.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e3:SetValue(c511000003.eqlimit)
...
function c511000003.eqlimit(e,c)
