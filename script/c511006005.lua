--メタル化・魔法反射装甲
function c511006005.initial_effect(c)
	--Activate
...
function c511006005.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated()
end
function c511006005.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511006005.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e4:SetCondition(c511006005.atkcon)
...
function c511006005.atkval(e,c)
