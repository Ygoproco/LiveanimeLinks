...
function c511009738.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)>0 then
		...
		tc:RegisterFlagEffect(511009738,RESET_EVENT+RESETS_STANDARD,0,1)
		local e1=Effect.CreateEffect(c)
		...
		e3:SetCondition(c511009738.startcon)
		e3:SetOperation(c511009738.startop)
...
function c511009738.startcon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	if not tc or tc:GetFlagEffect(511009738)==0 then e:Reset() return false end
	return Duel.GetTurnPlayer()==tp
end
function c511009738.startop(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	local e1=Effect.CreateEffect(e:GetHandler())
