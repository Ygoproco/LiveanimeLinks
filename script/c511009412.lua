...
function c511009412.initial_effect(c)
	...
	e2:SetCondition(c511009412.spcon)
	e2:SetTarget(c511009412.sptg)
	e2:SetOperation(c511009412.spop)
	c:RegisterEffect(e2)
end
function c511009412.spcon(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(aux.TRUE,tp,LOCATION_MZONE,0,nil)
	if g:GetCount()~=1 then return false end
	local tc=g:GetFirst()
	return tc:IsFaceup() and tc:IsRace(RACE_SPELLCASTER)
end
...
function c511009412.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511009412.spop(e,tp,eg,ep,ev,re,r,rp)
