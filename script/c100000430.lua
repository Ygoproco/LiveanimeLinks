...
function c100000430.cfilter(c)
	return c:IsSetCard(0x21)
end
function c100000430.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local dg=Duel.GetMatchingGroup(aux.TRUE,tp,0,LOCATION_MZONE,nil)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c100000430.cfilter,1,false,aux.ReleaseCheckTarget,nil,dg) end
	local g=Duel.SelectReleaseGroupCost(tp,c100000430.cfilter,1,1,false,aux.ReleaseCheckTarget,nil,dg)
