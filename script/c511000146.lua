...
function c511000146.filter1(c,e,tp,eg,ep,ev,re,r,rp)
...
function c511000146.filter2(c,e,tp,eg,ep,ev,re,r,rp)
	local te=c:CheckActivateEffect(false,false,false)
...
function c511000146.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		if (b and ft>1) or (not b and ft>0) then
			return Duel.IsExistingTarget(c511000146.filter1,tp,LOCATION_REMOVED,LOCATION_REMOVED,1,e:GetHandler(),e,tp,eg,ep,ev,re,r,rp)
		else
			return Duel.IsExistingTarget(c511000146.filter2,tp,LOCATION_REMOVED,LOCATION_REMOVED,1,e:GetHandler(),e,tp,eg,ep,ev,re,r,rp)
		end
	end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	if Duel.GetLocationCount(tp,LOCATION_SZONE)>0 then
		Duel.SelectTarget(tp,c511000146.filter1,tp,LOCATION_REMOVED,LOCATION_REMOVED,1,1,nil,e,tp,eg,ep,ev,re,r,rp)
	else
		Duel.SelectTarget(tp,c511000146.filter2,tp,LOCATION_REMOVED,LOCATION_REMOVED,1,1,nil,e,tp,eg,ep,ev,re,r,rp)
	end
end
