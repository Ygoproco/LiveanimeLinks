...
function c511600006.initial_effect(c)
	...
	e1:SetCondition(c511600006.condition)
...
function c511600006.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511600006.filter,tp,LOCATION_MZONE,0,2,nil)
end
