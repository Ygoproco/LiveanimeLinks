...
function c100000595.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg
	local g=Duel.GetMatchingGroup(c100000595.allfilter,tp,LOCATION_SZONE,0,nil)
	if g:GetCount()>0 then
		...
		sg=Duel.GetMatchingGroup(c100000595.filter,tp,LOCATION_SZONE,0,c):RandomSelect(tp,1)
	end
