...
function c511000555.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c511000555.filter(chkc) end
...
function c511000555.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local ct=Duel.GetMatchingGroupCount(c511000555.filter,tp,LOCATION_MZONE,0,nil)
