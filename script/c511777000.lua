--
function c511777000.initial_effect(c)
	--Heal or Hurt?idk
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511777000.target)
	e1:SetOperation(c511777000.operation)
	c:RegisterEffect(e1)
end
...
function c511777000.operation(e,tp,eg,ep,ev,re,r,rp)
