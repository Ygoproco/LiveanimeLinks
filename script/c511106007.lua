...
function s.tktg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetLocationCount(tu,LOCATION_MZONE)>0  
		and Duel.IsPlayerCanSpecialSummonMonster(tp,511009710,0x577,0x4011,0,0,1,RACE_CYBERSE,ATTRIBUTE_EARTH,POS_FACEUP,tu) end	
...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetHandler():IsRelateToEffect(e) and
	 Duel.GetLocationCount(tu,LOCATION_MZONE)>0 and
	  Duel.IsPlayerCanSpecialSummonMonster(tp,511009710,0x577,0x4011,0,0,1,RACE_CYBERSE,ATTRIBUTE_EARTH,POS_FACEUP,tu) then
