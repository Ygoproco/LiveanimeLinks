...
function c511009010.initial_effect(c)
	...
	e1:SetOperation(c511009010.activate)
	c:RegisterEffect(e1)
	--remove counter
	...
	e3:SetOperation(c511009010.ctop)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
...
function c511009010.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		...
		e1:SetCondition(c511009010.descon)
...
function c511009010.rmcfilter(c)
	return c:GetCounter(0x1109)~=0
end
function c511009010.rmop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c511009010.rmcfilter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
	local tc=g:GetFirst()
	while tc do
...
function c511009010.ctop(e,tp,eg,ep,ev,re,r,rp)
