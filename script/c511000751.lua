...
function c511000751.initial_effect(c)
	...
	e4:SetTarget(c511000751.thtg)
	e4:SetOperation(c511000751.thop)
	c:RegisterEffect(e4)
end
function c511000751.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000751.thop(e,tp,eg,ep,ev,re,r,rp)
