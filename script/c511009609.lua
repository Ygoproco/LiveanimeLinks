...
function c511009609.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c511009609.filter,tp,LOCATION_HAND,0,1,nil,e,tp) 
...
function c511009609.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c511009609.filter,tp,LOCATION_HAND,0,1,1,nil,e,tp):GetFirst()
