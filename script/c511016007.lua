...
function c511016007.initial_effect(c)
	...
	e1:SetTarget(c511016007.target)
	e1:SetOperation(c511016007.activate)
	c:RegisterEffect(e1)
	...
	e4:SetOperation(c511016007.tgop)
	c:RegisterEffect(e4)
end
function c511016007.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511016007.activate(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsRelateToEffect(e) then
		Duel.NegateAttack()
	end
end
function c511016007.tgop(e,tp,eg,ep,ev,re,r,rp)
