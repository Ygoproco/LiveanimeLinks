...
function c511024000.initial_effect(c)
	--ToHand
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(542100000,0))
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetTarget(c511024000.target)
	e1:SetOperation(c511024000.operation)
	c:RegisterEffect(e1)
end
function c511024000.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511024000.operation(e,tp,eg,ep,ev,re,r,rp)
