...
function c511009367.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c511009367.descon)
...
function c511009367.thtg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c511009367.thfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c511009367.thfilter,tp,LOCATION_MZONE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectTarget(tp,c511009367.thfilter,tp,LOCATION_MZONE,0,1,1,nil)
...
function c511009367.descon(e,tp,eg,ep,ev,re,r,rp)
