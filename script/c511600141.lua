...
function c511600141.initial_effect(c)
	--Activate
	...
	e1:SetCondition(c511600141.condition)
	e1:SetOperation(c511600141.operation)
	c:RegisterEffect(e1)
end
function c511600141.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE
end
function c511600141.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetValue(1)
	e2:SetCondition(c511600141.con)
	...
	if ac and (Duel.GetCurrentPhase()<PHASE_DAMAGE_CAL or not Duel.IsDamageCalculated()) then
		...
		at:SetTarget(c511600141.bttg)
		at:SetOperation(c511600141.btop)
...
function c511600141.bttg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511600141.btop(e,tp,eg,ep,ev,re,r,rp)
	Duel.CalculateDamage(e:GetLabelObject():GetFirst(),e:GetLabelObject():GetNext())
	e:Reset()
end
function c511600141.con(e,tp,eg,ep,ev,re,r,rp)
