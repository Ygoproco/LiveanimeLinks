...
function c511009667.initial_effect(c)
	...
	e3:SetTarget(c511009667.target)
	e3:SetOperation(c511009667.operation)
	c:RegisterEffect(e3)
end
...
function c511009667.matfilter2(c)
	return c:IsOriginalSetCard(0x574)
end
function c511009667.valcheck(e,c)
	if c:GetMaterial():IsExists(c511009660.matfilter2,1,nil,tp) then
