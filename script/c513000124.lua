...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,true,false,POS_FACEUP)~=0 then
		...
		r1:SetCode(EVENT_LEAVE_FIELD)
		r1:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE)
		r1:SetLabel(1-tp)
		r1:SetLabelObject(e4)
		r1:SetOperation(s.leaveop)
		c:RegisterEffect(r1)
		local r2=r1:Clone()
		r2:SetCode(EVENT_TO_DECK)
		c:RegisterEffect(r2)
		local r3=r1:Clone()
		r3:SetCode(EVENT_CHANGE_POS)
		c:RegisterEffect(r3)
		local r4=r1:Clone()
		r4:SetCode(EVENT_CONTROL_CHANGED)
		c:RegisterEffect(r4)
		local r5=r1:Clone()
		r5:SetCode(EVENT_BE_MATERIAL)
		c:RegisterEffect(r5)
	end
end
...
function s.leaveop(e,tp,eg,ep,ev,re,r,rp)
	local WIN_REASON_AUX_VOID=0x53
	Duel.Win(e:GetLabel(),WIN_REASON_AUX_VOID)
end
