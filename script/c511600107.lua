...
function c511600107.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e1:SetTarget(c511600107.target)
	e1:SetOperation(c511600107.operation)
	c:RegisterEffect(e1)
end
...
function c511600107.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.DiscardHand(tp,c511600107.cfilter,1,1,REASON_COST+REASON_DISCARD,e:GetHandler())
end
function c511600107.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
