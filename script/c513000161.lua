--Battle Fusion (Anime)
function c513000161.initial_effect(c)
	--ATK Up
	...
	e1:SetCondition(c513000161.condition)
	e1:SetOperation(c513000161.operation)
	c:RegisterEffect(e1)
end

function c513000161.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c513000161.operation(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
