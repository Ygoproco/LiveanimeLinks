...
function c511001698.filter(c,ft,tp)
...
function c511001698.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c511001698.filter,1,false,nil,nil,ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c511001698.filter,1,1,false,nil,nil,ft,tp)
