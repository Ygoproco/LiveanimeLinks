--Get Your Game On!
function c511000561.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511000561.target)
	c:RegisterEffect(e1)
	--atk down
	...
	e2:SetTarget(c511000561.atktg)
	e2:SetValue(c511000561.val)
	c:RegisterEffect(e2)
end
c511000561.illegal=true
function c511000561.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000561.atktg(e,c)
	return c:IsSetCard(0x3008) or c:IsSetCard(0x1f)
end
function c511000561.val(e,c)
