...
function c511600179.initial_effect(c)
	--activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_CHAINING)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DAMAGE_CAL)
	e1:SetCondition(c511600179.condition)
	c:RegisterEffect(e1)
	--avoid damage
	...
	e2:SetValue(c511600179.damval)
	c:RegisterEffect(e2)
end
function c511600179.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511600179.damval(e,re,val,r,rp,rc)
