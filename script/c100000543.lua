...
function c100000543.initial_effect(c)
	...
	e2:SetTarget(c100000543.tg)
	e2:SetOperation(c100000543.op)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c100000543.op(e,tp,eg,ep,ev,re,r,rp)
