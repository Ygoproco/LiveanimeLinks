...
function c511600069.initial_effect(c)
	...
	e3:SetCondition(c511600069.checkcon2)
	e3:SetOperation(c511600069.checkop2)
	c:RegisterEffect(e3)
	--equip effect
	...
	e6:SetCondition(function(e) return e:GetHandler():GetCardTarget():IsExists(c511600069.eqfilter,1,nil) end)
	c:RegisterEffect(e6)
	local e7=e6:Clone()
...
function c511600069.eqfilter(c)
	local code=c:GetOriginalCode()
	return code==58192742 or code==87756343
end
function c511600069.checkcon(e,tp,eg,ep,ev,re,r,rp)
	local g=e:GetHandler():GetCardTarget()
	return Duel.GetTurnPlayer()==tp and g and g:IsExists(c511600069.eqfilter,1,nil)
end
...
function c511600069.checkcon2(e,tp,eg,ep,ev,re,r,rp)
	local g=e:GetHandler():GetCardTarget()
	local g2=e:GetLabelObject() or Group.CreateGroup()
	return g:GetCount()>0 and not g:Equal(g2)
end
function c511600069.checkop2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=c:GetCardTarget()
	local g2=e:GetLabelObject()
	if not g:IsExists(c511600069.eqfilter,1,g:Filter(aux.TRUE,g2)) then
		c:SetTurnCounter(0)
	end
	g:KeepAlive()
	e:SetLabelObject(g)
