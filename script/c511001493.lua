...
function c511001493.spcheck(ft)
...
function c511001493.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-2 and Duel.CheckReleaseGroupCost(tp,nil,2,false,c511001493.spcheck(-ft+1),nil) end
	local sg=Duel.SelectReleaseGroupCost(tp,nil,2,2,false,c511001493.spcheck(-ft+1),nil)
...
function c511001493.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.GetFieldGroupCount(tp,0,LOCATION_HAND)~=0 
			and Duel.IsExistingMatchingCard(c511001493.filter,tp,0,LOCATION_GRAVE,1,nil,e,tp)
	end
