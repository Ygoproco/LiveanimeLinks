...
function c511009018.seqfilter(c,zone)
	return c:IsFaceup() and c:IsSetCard(0xfc) and c:GetSequence()<5 and Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE,c:GetControler(),LOCATION_REASON_CONTROL,zone)>0
end
