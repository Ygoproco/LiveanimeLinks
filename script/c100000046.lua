...
function c100000046.initial_effect(c)
	...
	e2:SetCondition(c100000046.sdcon)
	c:RegisterEffect(e2)
	--battle target
...
function c100000046.spfilter(c,ft,tp)
...
function c100000046.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(tp,c100000046.spfilter,1,nil,ft,tp)
end
function c100000046.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c100000046.spfilter,1,1,nil,Duel.GetLocationCount(tp,LOCATION_MZONE),tp)
	Duel.Release(g,REASON_COST)
end
function c100000046.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x3013)
end
function c100000046.sdcon(e,tp,eg,ep,ev,re,r,rp)
