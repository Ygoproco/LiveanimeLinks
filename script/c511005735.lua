...
function c511005735.initial_effect(c)
--when battle occurs revert monster to original ATK/DEF
local e1=Effect.CreateEffect(c)
e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
e1:SetCode(EVENT_PRE_DAMAGE_CALCULATE)
e1:SetRange(LOCATION_MZONE)
e1:SetCondition(c511005735.atkcon)
e1:SetOperation(c511005735.atkop)
c:RegisterEffect(e1)
end

function c511005735.atkcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511005735.atkop(e,tp,eg,ep,ev,re,r,rp)
if  Duel.GetAttacker()==nil or Duel.GetAttackTarget()==nil then return end	
local atk=0
