...
function c511000422.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.CheckReleaseGroupCost(tp,c511000422.cfilter,1,false,nil,nil,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c511000422.cfilter,1,1,false,nil,nil,tp)
