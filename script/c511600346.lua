...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsLocation(LOCATION_MZONE)
		and c:IsSetCard(0x234) and c:IsType(TYPE_LINK) and not c:IsReason(REASON_REPLACE) and c:IsReason(REASON_EFFECT)
end
...
function s.cfilter(c)
	return c:IsSetCard(0x234) and c:IsType(TYPE_LINK)
end
