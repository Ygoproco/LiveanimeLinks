...
function c511009660.initial_effect(c)
	...
	e1:SetTarget(c511009660.target)
	e1:SetOperation(c511009660.activate)
	c:RegisterEffect(e1)
	--destroy replace
...
function c511009660.desfilter(c,e)
...
function c511009660.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return eg:IsExists(c511009660.repfilter,1,nil,tp,c)
		and Duel.IsExistingMatchingCard(c511009660.desfilter,tp,LOCATION_ONFIELD,0,1,nil,e) end
	if Duel.SelectEffectYesNo(tp,c,96) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESREPLACE)
		local g=Duel.SelectMatchingCard(tp,c511009660.desfilter,tp,LOCATION_ONFIELD,0,1,1,nil,e)
...
function c511009660.repval(e,c)
	return c511009660.repfilter(c,e:GetHandlerPlayer(),e:GetHandler())
end
