...
function c58074177.distg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		if c:IsHasEffect(511009518) then
			return Duel.IsExistingMatchingCard(c58074177.disfilter,tp,0,LOCATION_MZONE,1,nil)
		else
			return Duel.IsExistingTarget(c58074177.disfilter,tp,0,LOCATION_MZONE,1,nil)
		end
	end
...
function c58074177.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsHasEffect(511009518) then
		g=Duel.GetMatchingGroup(c58074177.disfilter,tp,0,LOCATION_MZONE,nil)
	else
