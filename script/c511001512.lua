...
function c511001512.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local chk=tc and tc:IsRelateToEffect(e) and tc:IsFaceup()
...
function c511001512.ndop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ep==tp and Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE then
...
function c511001512.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:GetAttack()<val then
