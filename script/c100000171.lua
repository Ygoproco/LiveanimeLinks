...
function c100000171.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroup(tp,c100000171.costfilter,1,nil,ft) end
	local g=Duel.SelectReleaseGroup(tp,c100000171.costfilter,1,1,nil,ft)
