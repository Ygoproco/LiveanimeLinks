...
function c511756007.initial_effect(c)
	...
	e1:SetCondition(c511756007.condition)
	e1:SetTarget(c511756007.target)
	e1:SetOperation(c511756007.activate)
	c:RegisterEffect(e1)
end
function c511756007.cfilter(c,tp)
...
function c511756007.activate(e,tp,eg,ep,ev,re,r,rp)
