...
function c511009007.lvtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsFaceup() and c:IsLevelAbove(3)
		and Duel.GetMatchingGroupCount(c511009007.lvfilter,tp,LOCATION_MZONE,0,c)==Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)-1 end
end
function c511009007.lvop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tg=Duel.GetMatchingGroup(c511009007.lvfilter,tp,LOCATION_MZONE,0,c)
