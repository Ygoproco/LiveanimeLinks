...
function c511001363.op(e)
	...
	for c in aux.Next(g) do
		...
		for _,eff in ipairs(effs) do
			...
			e1:SetCondition(c511001363.copycon)
			e1:SetCost(c511001363.copycost)
			if max>0 then
...
function c511001363.copycon(e,tp,eg,ep,ev,re,r,rp)
	...
	return e:GetHandler():IsHasEffect(511001363) and Duel.GetTurnPlayer()==tp
		and e:GetOwner():GetFlagEffect(511001363)==0
		and (not con or con(e,tp,eg,ep,ev,re,r,rp))
end
function c511001363.copycost(e,tp,eg,ep,ev,re,r,rp,chk)
