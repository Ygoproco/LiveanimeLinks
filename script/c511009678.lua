...
function c511009678.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCost(c511009678.tdcost)
	e3:SetTarget(c511009678.tdtg)
	e3:SetOperation(c511009678.tdop)
	c:RegisterEffect(e3)
end
...
function c511009678.tdtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511009678.tdop(e,tp,eg,ep,ev,re,r,rp)
