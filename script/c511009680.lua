...
function c511009680.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCost(c511009680.atkcost)
	e3:SetOperation(c511009680.atkop)
	c:RegisterEffect(e3)
...
function c511009680.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511009680.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511009680.activate(e,tp,eg,ep,ev,re,r,rp)
