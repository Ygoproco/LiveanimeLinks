...
function c511002779.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsPlayerAffectedByEffect(tp,59822133) then ft=math.min(1,ft) end
	if ft<=0 or not Duel.IsPlayerCanSpecialSummonMonster(tp,27450401,0,0x4011,0,0,1,RACE_MACHINE,ATTRIBUTE_EARTH) then return end
	repeat
