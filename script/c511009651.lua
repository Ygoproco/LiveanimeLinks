...
function c511009651.immval(e,te)
	return te:GetOwner()~=e:GetOwner()
end
function c511009651.damcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511009651.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c511009651.damfilter,tp,LOCATION_GRAVE,0,nil)
