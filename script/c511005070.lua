...
function c511005070.initial_effect(c)
	...
	e3:SetCondition(c511005070.con)
	e3:SetOperation(c511005070.op)
	c:RegisterEffect(e3)
end
function c511005070.con(e,tp,eg,ep,ev,re,r,rp)
	local ph=Duel.GetCurrentPhase()
	return e:GetHandler():GetEquipTarget():GetBaseAttack()>0 and ph>=PHASE_BATTLE_START and ph<=PHASE_BATTLE
end
function c511005070.op(e,tp,eg,ep,ev,re,r,rp)
