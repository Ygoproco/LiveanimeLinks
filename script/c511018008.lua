--Duel
function c511018008.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_DRAW)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511018008.target)
	e1:SetOperation(c511018008.operation)
	c:RegisterEffect(e1)
end
function c511018008.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511018008.operation(e,tp,eg,ep,ev,re,r,rp)
