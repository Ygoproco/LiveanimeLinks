...
function c511600027.rescon(sg,e,tp,mg)
...
function c511600027.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ft<=0 or g:GetCount()==0 or not e:GetHandler():IsRelateToEffect(e) then return end
	if Duel.IsPlayerAffectedByEffect(tp,59822133) then ft=1 end
	ft=math.min(ft,2)
	local sg=aux.SelectUnselectGroup(g,e,tp,nil,ft,c511600027.rescon,1,tp,HINTMSG_SPSUMMON,c511600027.rescon)
