...
function c511009520.initial_effect(c)
	--synchro summon
	...
	e2:SetTarget(c511009520.target)
	e2:SetOperation(c511009520.operation)
	c:RegisterEffect(e2)
end

function c511009520.filter(c,e,tp)
	return c:IsSetCard(0x9a) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c511009520.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c511009520.filter,tp,LOCATION_HAND,0,1,nil,e,tp) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND)
end
function c511009520.operation(e,tp,eg,ep,ev,re,r,rp)
	local ct=2
