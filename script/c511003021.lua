--霊子エネルギー固定装置
function c511003021.initial_effect(c)
	--Activate
	...
	e4:SetCountLimit(1)
	e4:SetCondition(c511003021.mtcon)
	e4:SetOperation(c511003021.mtop)
	c:RegisterEffect(e4)
end
function c511003021.mtcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c511003021.mtop(e,tp,eg,ep,ev,re,r,rp)
