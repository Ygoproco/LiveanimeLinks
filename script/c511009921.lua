...
function c511009921.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetCondition(c511009921.spcon)
...
function c511009921.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,511009926,0x579,0x4011,100,100,1,RACE_CYBERSE,ATTRIBUTE_WATER) then return end
