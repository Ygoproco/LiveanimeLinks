...
function c511000839.initial_effect(c)
	...
	e1:SetOperation(c511000839.activate)
	c:RegisterEffect(e1)
end
function c511000839.activate(e,tp,eg,ep,ev,re,r,rp)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_AVAILABLE_BD)
	e1:SetTargetRange(1,0)
	e1:SetValue(c511000839.refcon)
	e1:SetLabel(0)
	...
	e2:SetValue(c511000839.refcon)
	e2:SetLabel(0)
	Duel.RegisterEffect(e2,tp)
	e1:SetLabelObject(e2)
end
function c511000839.refcon(e,re,val,r,rp,rc)
