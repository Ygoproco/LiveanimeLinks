...
function c511000664.initial_effect(c)
	...
	e4:SetCondition(c511000664.rmcon)
	e4:SetTarget(c511000664.rmtg)
	e4:SetOperation(c511000664.rmop)
	c:RegisterEffect(e4)
end
function c511000664.rmcon(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp and Duel.GetAttackTarget()==nil and eg:GetFirst()==e:GetHandler():GetEquipTarget()
end
function c511000664.rmtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,2,0,0)
end
function c511000664.rmop(e,tp,eg,ep,ev,re,r,rp)
...
function c511000664.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetTurnPlayer()~=tp or g:IsExists(c511000664.cfilter,1,nil) then return end
	local c=e:GetHandler()
	local ec=g:GetFirst()
	if c==ec then
		ec=g:GetNext()
