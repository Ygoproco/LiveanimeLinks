...
function c511009427.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(511009427,0))
...
function c511009427.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then returnnot Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		and Duel.GetLocationCount(tp,LOCATION_MZONE)>2
		and Duel.IsPlayerCanSpecialSummonMonster(tp,511009428,0,0x4011,0,0,1,RACE_CYBERSE,ATTRIBUTE_EARTH) end
