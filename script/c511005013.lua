...
c511005013.collection={
	[21524779]=true,[84530620]=true,[57019473]=true,[48049769]=true,[84417082]=true,
	[27217742]=true,[511005013]=true
}
function c511005013.filter(c)
	return c:IsFaceup() and c511005013.collection[c:GetCode()]
end
