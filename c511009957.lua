...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.CheckReleaseGroupCost(tp,s.desfilter,1,false,s.spcheck,nil,dg)
	end
	local sg=Duel.SelectReleaseGroupCost(tp,s.desfilter,1,1,false,s.spcheck,nil,dg)
